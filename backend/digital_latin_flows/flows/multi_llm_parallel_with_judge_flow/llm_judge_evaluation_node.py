...
from digital_latin_flows.flows.multi_llm_parallel_flow.nodes.multi_llm_invocation import invoke_llm

# Always resolve EVAL_RESULTS_DIR under digital_latin_flows
PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..'))
EVAL_RESULTS_DIR = os.path.join(PROJECT_ROOT, 'digital_latin_flows', 'evaluation', 'llm_as_judge_results')
...
if not os.path.exists(MAIN_RESULTS_DIR):
    # Try the digital_latin_flows/results path if not found
    MAIN_RESULTS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../results'))
    if not os.path.exists(MAIN_RESULTS_DIR):
        MAIN_RESULTS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../../digital_latin_flows/results'))
