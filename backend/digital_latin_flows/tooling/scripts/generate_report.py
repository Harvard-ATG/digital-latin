...
def generate_run_report(
    ...
    # The reports and counter file will be saved in fas_llm_applications/digital_latin_flows/results
    results_folder_path = os.path.join(project_root, "backend",
                                       "digital_latin_flows", REPORT_FOLDER_NAME)
